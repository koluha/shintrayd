...
use app\models\base\DbVendorTire;
use app\modules\admin\models\SpecifTire;
use yii\filters\VerbFilter;
use app\models\base\DFileHelper;

class SpeciftireController extends AppAdminController {
    ...
    public function actionUpdate($id) {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $ob_imgs = DbSpecifTire::arr_imgs($model->imgs);
    ...
    protected function findModel($id) {
        if (($model = DbSpecifTire::findOne($id)) !== null) {
            return $model;
        } else {
